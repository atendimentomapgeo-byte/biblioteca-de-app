...
(function () {
  ...
  const MapModule = {
    init(containerId, settings) {
      ...
      // Camada online opcional (OpenStreetMap). Só é útil quando há internet;
      // continua registrada, mas não é ativada por padrão, respeitando o
      // requisito de não depender de conexão.
      baseLayers['osm'] = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
        maxZoom: 19,
        attribution: '&copy; OpenStreetMap contributors (requer internet)',
      });
